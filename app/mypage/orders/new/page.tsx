            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-green-600 font-medium mt-0.5">＋動画制作1本無料</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {type === "lp" && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div className="text-sm text-green-800">
              <p className="font-medium">LP制作特典（Start Upコース相当）</p>
              <p className="mt-1">LP制作をお申し込みいただくと、動画制作1本が無料で自動追加されます。</p>
            </div>
          </div>
        )}
